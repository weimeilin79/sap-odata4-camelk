sap.ui.define([
	"sap/ui/test/Opa5",
	"socreation_test/SO_Create/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function (Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("socreation_test.SO_Create.test.integration.arrangements.Startup", {
		...
		iStartMyApp: function (oOptionsParameter) {
			...
			this.iStartMyUIComponent({
				componentConfig: {
					name: "socreation_test.SO_Create",
					async: true
				},
				hash: oOptions.hash,
