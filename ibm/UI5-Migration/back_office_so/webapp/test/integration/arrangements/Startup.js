sap.ui.define([
	"sap/ui/test/Opa5",
	"soapproved/SO_APPROVED_LIST_Details/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function (Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("soapproved.SO_APPROVED_LIST_Details.test.integration.arrangements.Startup", {
		...
		iStartMyApp: function (oOptionsParameter) {
			...
			this.iStartMyUIComponent({
				componentConfig: {
					name: "soapproved.SO_APPROVED_LIST_Details",
					async: true
				},
				hash: oOptions.hash,
