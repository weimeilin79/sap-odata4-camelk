sap.ui.define([
	"sap/ui/test/Opa5",
	"SO_Approval/SO_Approval/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function(Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("SO_Approval.SO_Approval.test.integration.arrangements.Startup", {
